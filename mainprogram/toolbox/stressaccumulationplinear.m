function [stressyx,stressyz,elapsedtime,v,dt]=...
stressaccumulationplinear(stressyx,stressyz,etaeff,elapsedtime,model,femodel)
global modc fi
%% stress ???�???�???�@effective viscosity and viscous shear strain rate
[esyxv,esyzv]=stress2viscolinear(stressyx,stressyz,etaeff);
